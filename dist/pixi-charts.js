...
class LabelsDrawer extends BaseDrawer {constructor(...args) { super(...args); LabelsDrawer.prototype.__init.call(this);LabelsDrawer.prototype.__init2.call(this); }
     __init() {this.node = new graphics.Graphics();}
...
class Chart extends display.Container {
     ...
     __init4() {this._rangeScale = new math.Point(1, 1);}
     __init5() {this._rangeTranslate = new math.Point(0,0);}
...
class ChartApp {
     ...
     __init() {this.stage = new display.Container();}
     __init2() {this.size
