...
/*!
 * @pixi/charts - v0.1.6
 * Compiled Tue, 14 Sep 2021 13:18:14 UTC
 *
 ...
 */
class DataTransformPlugin  {constructor() { DataTransformPlugin.prototype.__init.call(this);DataTransformPlugin.prototype.__init2.call(this); }
	  __init() {this.name = 'DataTransformPlugin';}

	

	  __init2() {this.reduceXRange = true;}
...
class LineDrawer extends BaseDrawer {constructor(...args) { super(...args); LineDrawer.prototype.__init.call(this);LineDrawer.prototype.__init2.call(this); }
     ...
     */
     update(force = false) {
        ...
        dataBounds.toY - dataBounds.fromY;
...
var LABEL_ORIENTATION; (function (LABEL_ORIENTATION) {
    const LEFT = 'left'; LABEL_ORIENTATION["LEFT"] = LEFT;
    const RIGHT = 'right'; LABEL_ORIENTATION["RIGHT"] = RIGHT;
})(LABEL_ORIENTATION || (LABEL_ORIENTATION = {}));
var RENDER_MODE; (function (RENDER_MODE) {
    const NORMAL = 'normal'; RENDER_MODE["NORMAL"] = NORMAL;
    const ONLY_X = 'only_x'; RENDER_MODE["ONLY_X"] = ONLY_X;
    const ONLY_Y = 'only_y'; RENDER_MODE["ONLY_Y"] = ONLY_Y;
})(RENDER_MODE || (RENDER_MODE = {}));

class LabelsDrawer extends BaseDrawer {constructor(...args) { super(...args); LabelsDrawer.prototype.__init.call(this);LabelsDrawer.prototype.__init2.call(this); }
     __init() {this.node = new Graphics();}
...
class Chart extends Container {
     ...
     __init4() {this._rangeScale = new Point(1, 1);}
     __init5() {this._rangeTranslate = new Point(0,0);}

      __init6() {this._plugins = [];}
      __init7() {this._activePlugins = [];}
     ...
     parse() {
        ...
        if (!dataProvider) {
            ...
            if (Array.isArray(firstEntry) && firstEntry.length === 2) {
                ...
                labelProvider = new ArrayLikeDataProvider(labels , true) ;
            }
        }

        this.dataProvider = new PluggableProvider(dataProvider, this);
        this.labelProvider = new PluggableProvider(labelProvider , this) ;
...
export { ArrayChainDataProvider, ArrayLikeDataProvider, BaseDrawer, CHART_EVENTS, CHART_TYPE, Chart, ChartApp, DataTransformPlugin, ObjectDataProvider, Observable, PluggableProvider, Range, parseStyle };
