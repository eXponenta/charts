...
class ChartApp {
     ...
     __init2() {this.stage = new Container();}
     __init3() {this.size
...
export { ArrayChainDataProvider, ArrayLikeDataProvider, BaseDrawer, CHART_EVENTS, CHART_TYPE, Chart, ChartApp, DataTransformPlugin, LABEL_LOCATION, ObjectDataProvider, Observable, PluggableProvider, Range, parseStyle };
